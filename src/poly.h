...
/**
 * Makro sprawdzające czy alokacja pamięci się powiodła.
 * Jeśli nie, program zostaje zakończony z kodem 1.
 * @param[in] p : wskaźnik
 */
#define CHECK_PTR(p)  \
  do {                \
...
/**
 * Dodaje dwa jednomiany o jednakowym wykładniku.
 ...
 * @param[in] count : liczba jednomianow
 ...
 * najprostszą reprezentację wielomianu.
 * @param[in] p : wielomian @f$ p @f$
 */
